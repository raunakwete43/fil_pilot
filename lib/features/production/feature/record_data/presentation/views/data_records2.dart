...
class DataRecords2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: SocketingMachineConditionReport(),
      ),
    );
  }
}
...
class _SocketingMachineConditionReportState
  ...
  void initState() {
    ...
    _controllers = List.generate(
        widget.parameters.length, (index) => TextEditingController());
    _downtimeControllers = List.generate(
        3, (index) => List.generate(5, (index) => TextEditingController()));
    _wastageControllers = List.generate(
        3, (index) => List.generate(3, (index) => TextEditingController()));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Socketing Machine Condition Report',
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        rows: List.generate(
          ...
          (index) => DataRow(
            cells: [
              DataCell(Text(widget.parameters[index]['parameter']!)),
              DataCell(Text(widget.parameters[index]['uom']!)),
              DataCell(
                SizedBox(
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: const [
          ...
          DataColumn(
            label: Text('From', style: boldStyle),
          ),
          DataColumn(
            label: Text('To', style: boldStyle),
          ),
